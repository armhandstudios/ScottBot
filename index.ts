...
function getGuildInGuildList(guildList: Array<GuildSettings>, targetGuildId: string): GuildSettings
{
    for(var guild of guildList)
    {
...
bot.on("ready", async () =>
{
    ...
    var guildSettingsList: Array<GuildSettings> = null;
